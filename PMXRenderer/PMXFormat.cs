	...
	namespace PMX
	{
		...
		public class PMXFormat
		{
			...
			public class BDEF1 : BoneWeight
			{
				...
				public Vector3 c_value {get{return new Vector3(0,0,0);}}
				public Vector3 r0_value {get{return new Vector3(0,0,0);}}
				public Vector3 r1_value {get{return new Vector3(0,0,0);}}
			}
